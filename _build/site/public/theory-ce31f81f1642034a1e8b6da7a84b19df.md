...
constant and $T$ the absolute temperature (Chandler 1978; Frenkel and
Smit 2023; Tuckerman 2023). The normalization constant of the
...
entropy, avoid mixing entropy (Gibbs) paradoxes(Noyes 1961; Frenkel and
Smit 2023; Tuckerman 2023) and recover the Sackur-Tetrode entropy of the
ideal gas (Huang 1987). Following convention, we will use angular
...
is in this case (Tuckerman 2023):
...
equilibrium probability $p(\xi)$ as (Kirkwood 1935; Tuckerman 2023;
...
contributes to the configurational entropy $S(\xi)$ (Gimondi, Tribello,
and Salvalaglio 2018; Dietschreit, Diestler, and Gómez-Bombarelli 2023).
...
than energetic, contributions (Gimondi, Tribello, and Salvalaglio 2018;
Polino et al. 2020; Kollias et al. 2020; Leanza et al. 2023; Serse et
al. 2024).
...
permission from Ref. (Gimondi, Tribello, and Salvalaglio
2018)
```
