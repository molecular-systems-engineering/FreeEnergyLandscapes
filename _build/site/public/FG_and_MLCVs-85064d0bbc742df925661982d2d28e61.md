...
reader to the extensive overviews by Noeét al. (Noé et al. 2020), Mehdi
et al. and (Mehdi et al. 2024), Zhu et al.(Zhu et al. 2025).
...
representations directly from simulation trajectories (Gökdemir and
Rydzewski 2025; Desgranges and Delhommelle 2025; Neha et al. 2022). The
...
approaches---including principal component analysis (Garcı́a 1992;
Amadei, Linssen, and Berendsen 1993; Hegger et al. 2007; Wetzel 2017),
diffusion maps (Ferguson et al. 2011; Preto and Clementi 2014),
sketch-map (Ceriotti, Tribello, and Parrinello 2011; Tribello, Ceriotti,
and Parrinello 2012), and autoencoders (W. Chen and Ferguson 2018;
Wehmeyer and Noé 2018; Lemke and Peter 2019)---learn low-dimensional
...
(Noé and Nuske 2013; Nuske et al. 2014)) defines an optimal reaction
...
component analysis (TICA) (Pérez-Hernández et al. 2013), VAMPnets (Mardt
et al. 2018), and state-free reversible VAMPnets (SRV) (W. Chen, Sidky,
and Ferguson 2019) learn nonlinear transformations that approximate
these slow eigenmodes, often in the form of neural-network embeddings.
...
(Ribeiro et al. 2018), SPIB (Wang, Ribeiro, and Tiwary 2019) and
variational dynamic encoders (VDE) (Hernández et al. 2018), which train
...
(Mendels, Piccini, and Parrinello 2018; Piccini, Mendels, and Parrinello
2018). Their nonlinear extensions, Deep-LDA and Deep-TDA, replace the
...
MetaD, VES, and OPES for free-energy reconstruction (Bonati, Rizzi, and
Parrinello 2020; Trizio and Parrinello 2021). These algorithms have
found widespread applications across various fields, including ligand
binding (Wang, Ribeiro, and Tiwary 2019), conformational transitions
(Hernández et al. 2018; Mardt et al. 2018; W. Chen, Sidky, and Ferguson
2019; Preto and Clementi 2014), self-assembly(Jung et al. 2023;
Boninsegna, Banisch, and Clementi 2018), and phase transformations
(Finney and Salvalaglio 2023; Zou et al. 2023).
...
Steinhardt order parameters (F. et al. 2023; Zhang et al. 2024). Two
recent examples demonstrate the potential of this approach. In Dietrich
et al. (F. et al. 2023), graph-based models were trained to approximate
...
metadynamics. Similarly, Zhang et al. (Zhang et al. 2024) introduced
...
**A,B.** Deep-LDA
(Bonati, Rizzi, and Parrinello 2020) combines nonlinear neural-network
...
feature rankings. **C,D.** Graph neural-network (GNN) CVs (F. et al.
2023) operate directly on molecular graphs built from atomic
