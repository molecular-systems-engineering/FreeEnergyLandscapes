...
Na$^+$Cl$^-$ ion pair in water, investigated by Geissler et al. [@Geissler1999]. As illustrated by Geissler,
...
perpendicularly to the puckering sphere (right panel). [@sega2009calculation].
```
...
such as distances and angles [@henin2022enhanced; @fiorin2013using; @plumed2019promoting; @tribello2025plumed], as well as more
complex functions, including measures of structural similarity
[@pietrucci2009collective] or progress along a path defined by a set of
reference structures [@branduardi2007b]. It
should be noted that CVs do not necessarily require a direct physical
interpretation, and they can be abstract or highly engineered [@pietrucci2011graph]. 
...
states [@tribello2012using], while losing a direct physical
...
phases or states of matter [@neha2022collective; @desgranges2025deciphering; @giberti2015metadynamics]. OPs typically reflect
...
effective [@gobbo2018nucleation; @Gimondi_2017; @francia2020systematic]. 
...
probability, originally introduced by Onsager [@onsager1938initial], provides the most rigorous definition of a reaction coordinate for a system evolving from state A to state B. It is the probability that a
...
information [@Geissler1999], a
concept central to both path sampling [@bolhuis2002transition; @van2005elaborating] and modern data-driven approaches.
...
successive improvements [@ruiz1997efficient] require an
